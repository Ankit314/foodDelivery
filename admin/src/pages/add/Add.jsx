...
const Add = ({url}) => {
    ...
    return (
        <div className='add'>
            <form className="flex-col" onSubmit={onSubmitHandlar}>
                ...
                <div className="add-product-descriptions flex-col">
                    ...
                    <textarea onChange={onChangeHandlar} name="descriptions" rows="6" placeholder='Write Content Here' required></textarea>
                ...
                <div className="add-category-price">
                    <div className="add-category flex-col">
                        <p>Add category</p>
                        <select onChange={onChangeHandlar} value={data.category} name="category"  >
